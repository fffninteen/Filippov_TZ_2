...
В файле App.java реализована простейшая программа из условия, все необходимые тесты также написаны.

### График заисимости времени выполнения от кол-ва чисел в файле (реализован на функции поиска минимума)
![image](https://github.com/fffninteen/Filippov_TZ_2/assets/164251870/1a5bd174-5a70-4c7c-b520-03fa0f7ed8d4)

### Часть 2

Подключена CI-система, настроен автоматический прогон тестов, выведен бейдж
